...
xref:aasx.adoc[] is the normative part of the document. It specifies how the information of one or more Administration Shells can be packed into a compound file format (AASX). Background information with respect to this format can be found in Annex A.
...
The Annex contains additional background information on the exchange format (xref:annex/background.adoc[]).
