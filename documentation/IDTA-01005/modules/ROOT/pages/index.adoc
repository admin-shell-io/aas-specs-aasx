...
This version, version 3.1, was produced from February 2023 to May 2024 by the Workstream "Specifications of the Asset Administration Shell" of the "Open Technology" working group of the Industrial Digital Twin Association (IDTA). 
